...
if __name__ == '__main__':
    ...
    #爬取目標 (要使用mbasic的網址)
    url = 'https://mbasic.facebook.com/groups/level1buyit/permalink/2887524364843000/'
    #url = 'https://www.facebook.com/groups/level1buyit/posts/2887524364843000/'
    
    #crawl
    crawlFB = Crawl_fb(account=account, password=password, driver_location=driver)
    crawlFB.crawl(url=url)
